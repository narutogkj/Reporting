                            ...
                            <table id="datatable-buttons" class="table table-striped table-responsive table-bordered w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-top-0">created_by</th>
                                        <th class="border-top-0">register</th>
                                        <th class="border-top-0">batch_id</th>
                                        <th class="border-top-0">trans_id</th>
                                        <th class="border-top-0">trans_type</th>
                                        <th class="border-top-0">tender_type</th>
                                        <th class="border-top-0">Amount</th>
                                        <th class="border-top-0">tender_type_note</th>
                                ...
                                <tbody>
                                    ...
                                    if ( !isset( $_POST['submit'] ) ) {
                                        include './fetch/getCashDiscrepancyReport.php'; 
                                    }else {
                                        include './fetch/getCashDiscrepancyReportByDate.php';
                                    }
                                    ?>
